                ...
                <div className="w-full sm:w-[400px] h-full bg-white overflow-y-scroll">
                    ...
                    <header className="bg-indigo-300 p-3 flex flex-row  justify-between">
                        <Image 
                            width={58} height= {58}
                            className='w-[120px]' 
                            src="/imgs/facepal_logo.png" alt="profile photo" 
                        />
                        <Image 
                            className="rounded-full" width={58} height= {58} 
                    ...
                    <div className="flex flex-col gap-2 p-3">
                        ...
                        <div className="border border-gray-100 rounded-md p-3">   {/* single post */}
                            ...
                            <p className='text-black'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus, tenetur. Natus provident id quae delectus ab. Asperiores, veritatis!</p>
